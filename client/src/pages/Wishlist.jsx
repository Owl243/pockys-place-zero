        ...
        <div className="container py-3 mb-5">
            <div className="d-flex justify-content-between align-items-end mb-5">
                <div className="text-start">
                    ...
                    <p className="text-muted small mb-0">Cartas que estás deseando conseguir</p>
                </div>
                <div className="bg-pink bg-opacity-10 px-3 py-2 rounded-4 border border-pink border-opacity-20">
                    <span className="fw-bold text-pink">{cards.length} Deseadas</span>
                </div>
            </div>
                        ...
                        <div className="col-6 col-md-4 col-lg-3 mb-4" key={card.id}>
                            <div className="card h-100 border-0 rounded-5 overflow-hidden bg-dark bg-opacity-30 backdrop-blur-sm border border-white border-opacity-5 shadow-2xl transition-all hover-translate-y-n2">
                                <div className="p-4 bg-dark bg-opacity-50 d-flex align-items-center justify-content-center position-relative overflow-hidden" style={{ height: "260px" }}>
                                    <div className="position-absolute w-100 h-100 bg-pink opacity-5" style={{ filter: 'blur(50px)', top: '10%', left: '10%' }}></div>
                                ...
                                <div className="card-body p-4 text-start d-flex flex-column">
                                    <div className="mb-2">
                                        <span className="badge bg-pink bg-opacity-10 text-pink border border-pink border-opacity-20 rounded-pill px-2 py-1" style={{ fontSize: '0.6rem' }}>
                                            Deseada
                                        </span>
                                    </div>
