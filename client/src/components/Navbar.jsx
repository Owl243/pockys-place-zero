...
export default function Navbar({ user, onToggleNotifs, notifCount }) {
                ...
                <div className="collapse navbar-collapse" id="navbarNav">
                    <ul className="navbar-nav mx-auto gap-2">
                        ...
                        {user && (
                            <>
                                <li className="nav-item">
                                    <Link className={`nav-link px-3 rounded-pill ${isActive("/search") ? "active active-emerald fw-bold" : "text-white-80"}`} to="/search">
                                        TCG
                                    </Link>
                                </li>
                                <li className="nav-item">
                    ...
                    {user ? (
                        <>
                            ...
                            <button
                                ...
                                className="btn btn-dark bg-opacity-40 border-white border-opacity-10 rounded-circle p-2 position-relative shadow-sm transition-all me-2"
                            >
                        ...
                        <>
                            <button
                                className="btn btn-sm rounded-pill px-3 py-2 text-white"
                                style={{ background: "rgba(255,255,255,0.07)", border: "1px solid rgba(255,255,255,0.15)", fontSize: "0.85rem" }}
                            ...
                            <button
                                ...
                                style={{ background: "linear-gradient(135deg,#10b981,#059669)", border: "none", fontSize: "0.85rem" }}
